...
export class ParticipantElementVariablesProviderService implements ProcessEditorElementVariablesProvider {
    ...
    getVariablesFromElement(element: Bpmn.DiagramElement): Observable<ElementVariable[]> {
        ...
        const processDefinitionKey = element.businessObject.processRef.id;
