...
import { BpmnProperty, EmailServiceTaskItemModel } from '@alfresco-dbp/modeling-shared/sdk';
import { FactoryProps } from './interfaces/cardview-properties.interfaces';

const property = BpmnProperty.implementation;

export function createEmailServiceTaskProperty({ element }: FactoryProps) {
    return new EmailServiceTaskItemModel({
        label: 'PROCESS_EDITOR.ELEMENT_PROPERTIES.EMAIL_SERVICE_TASK',
