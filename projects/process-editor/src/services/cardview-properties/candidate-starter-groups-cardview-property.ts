...
const propertyName = BpmnProperty.candidateStarterGroups;

export function createCandidateStarterGroupsProperty({ element }: FactoryProps) {
    return new CardViewTextItemModel({
        label: 'PROCESS_EDITOR.ELEMENT_PROPERTIES.CANDIDATE_STARTER_GROUPS',
