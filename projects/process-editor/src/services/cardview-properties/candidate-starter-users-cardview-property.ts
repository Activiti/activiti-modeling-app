...
const propertyName = BpmnProperty.candidateStarterUsers;

export function createCandidateStarterUsersProperty({ element }: FactoryProps) {
    return new CardViewTextItemModel({
        label: 'PROCESS_EDITOR.ELEMENT_PROPERTIES.CANDIDATE_STARTER_USERS',
