...
const propertyName = BpmnProperty.correlationKey;

export function createCorrelationKeyProperty({ element }: FactoryProps) {
    return new CardViewTextItemModel({
        label: 'PROCESS_EDITOR.ELEMENT_PROPERTIES.CORRELATION_KEY',
