...
describe('LoopCharacteristics', () => {
    const property = BpmnProperty.loopCharacteristics;
    ...
    beforeEach(() => {
        ...
        mockElement = getDiagramElementMock({ [property]: 'test' });
    ...
    describe('get', () => {
        it('should return the LoopCharacteristics property from the element', () => {
    ...
    describe('set', () => {
        it('should set the new LoopCharacteristics property value', () => {
