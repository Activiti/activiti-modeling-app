...
@Component({
    templateUrl: './float-number-input.component.html'
})

export class PropertiesViewerFloatNumberInputComponent extends PropertiesViewerModelValidatedInputComponent {
    ...
    getPlaceholder(): string {
        return this.placeholder ? this.placeholder : 'SDK.VALUE';
    }
}
