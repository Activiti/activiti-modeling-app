...
export function logWarning(initiator: LogMessageInitiator, messages: string | string[]) {
    return new LogAction({
        type: MESSAGE.WARN,
        datetime: new Date(),
        initiator,
...
export function logError(initiator: LogMessageInitiator, messages: string | string[]) {
    return new LogAction({
        type: MESSAGE.ERROR,
        datetime: new Date(),
        initiator,
