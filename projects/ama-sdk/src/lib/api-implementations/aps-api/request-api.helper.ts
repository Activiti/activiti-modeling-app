...
export class RequestApiHelper {
    ...
    public get(endPoint: string, overriddenOptions?: RequestApiHelperOptions) {
    ...
    private request(httpMethod: string, endPoint: string, overriddenOptions?: RequestApiHelperOptions) {
