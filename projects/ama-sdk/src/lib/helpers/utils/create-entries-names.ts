...
export const CONNECTOR_NAME_REGEX = /^[a-z0-9]([-a-z0-9]{0,24}[a-z0-9])?$/;
export const PROJECT_NAME_REGEX = /^[a-z0-9]([-a-z0-9]{0,24}[a-z0-9])?$/;
export const UI_NAME_REGEX = /^[a-z0-9]([-a-z0-9]{0,24}[a-z0-9])?$/;
