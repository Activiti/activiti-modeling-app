...
export abstract class ConnectorApi {
    ...
    public abstract retrieve(connectorId: string, applicationId: string): Observable<Connector>;
    public abstract update(connectorId: string, content: ConnectorContent, applicationId: string): Observable<Connector>;
