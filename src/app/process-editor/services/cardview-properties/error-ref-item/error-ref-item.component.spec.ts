    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            providers: [
                ...
                { provide: ProcessModelerServiceToken, useValue: { getRootProcessElement: jest.fn() } },
                { provide: ProcessConnectorService, useValue: { getContent: jest.fn().mockReturnValue(of()) } },
                {
                    provide: Store,
                    useValue: {
