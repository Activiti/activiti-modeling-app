...
export class CardViewProcessErrorsItemModel extends CardViewBaseItemModel implements CardViewItem, DynamicComponentModel {
    type = BpmnCompositeProperty.errors;
