...
describe('ProcessHeaderComponent', () => {
    ...
    it('should render breadcrumbs', () => {
        const breadcrumbs = fixture.debugElement.query(By.css('ama-header-breadcrumbs'));
    ...
    it('should test download button', () => {
        ...
        const button = fixture.debugElement.query(By.css('[data-automation-id="download-button"]'));
    ...
    it('should test save button', () => {
        ...
        const button = fixture.debugElement.query(By.css('[data-automation-id="save-button"]'));
        button.triggerEventHandler('click', {});
        fixture.detectChanges();
    ...
    it('should test delete button', () => {
        ...
        const menuButton = fixture.debugElement.query(By.css('[data-automation-id="menu-button"]'));
        menuButton.triggerEventHandler('click', {});
        fixture.detectChanges();

        const deleteButton = fixture.debugElement.query(By.css('[data-automation-id="delete-button"]'));
