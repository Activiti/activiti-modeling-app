...
@Component({
    templateUrl: './connector-settings.dialog.component.html'
})

export class ConnectorSettingsDialogComponent {
    checked = false;
    ...
    submit() {
        this.store.dispatch(new ChangedConnectorSettingsAction(this.checked));
        this.dialog.close();
    }
}
