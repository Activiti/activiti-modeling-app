...
describe('Boundary Timer - Non-Interrupting', async () => {
    ...
    it('[C311477] Create process with Boundary Timer (Non-Interrupting) - Cycle', async () => {
        const processFilePath = 'e2e/resources/process/timers/BoundaryTimerNonInterruptingCycle.bpmn20.xml';
    ...
    it('[C311478] Create process with Boundary Timer (Non-Interrupting) - Date', async () => {
        const processFilePath = 'e2e/resources/process/timers/BoundaryTimerNonInterruptingDate.bpmn20.xml';
    ...
    it('[C311479] Create process with Boundary Timer (Non-Interrupting) - Duration', async () => {
        const processFilePath = 'e2e/resources/process/timers/BoundaryTimerNonInterruptingDuration.bpmn20.xml';
