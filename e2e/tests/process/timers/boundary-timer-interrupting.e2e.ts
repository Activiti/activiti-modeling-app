 ...
 */
 ...
 describe('Boundary Timer - Interrupting', async () => {
     ...
     it('[C311473] Create process with Boundary Timer (Interrupting) - Cycle', async () => {
         const processFilePath = 'e2e/resources/process/timers/BoundaryTimerInterruptingCycle.bpmn20.xml';
     ...
     it('[C311475] Create process with Boundary Timer (Interrupting) - Date', async () => {
         const processFilePath = 'e2e/resources/process/timers/BoundaryTimerInterruptingDate.bpmn20.xml';
     ...
     it('[C311476] Create process with Boundary Timer (Interrupting) - Duration', async () => {
         const processFilePath = 'e2e/resources/process/timers/BoundaryTimerInterruptingDuration.bpmn20.xml';
